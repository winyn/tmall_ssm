            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${pgle}" var="ps">
                        <tr>
                            <td>${ps.id}</td>
                            <td>
                                <a title="点击查看原图" href="img/productSingle/${ps.id}.jpg"><img height="50px" src="img/productSingle/${ps.id}.jpg"></a>
                            </td>
                            <td><a deleteLink="true"
                                   href="admin_productImage_delete?id=${ps.id}&pid=${ps.pid}"><span
            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${pdil}" var="pd">
                        <tr>
                            <td>${pd.id}</td>
                            <td>
                                <a title="点击查看原图" href="img/productDetail/${pd.id}.jpg"><img height="50px" src="img/productDetail/${pd.id}.jpg"></a>
                            </td>
                            <td><a deleteLink="true"
                                   href="admin_productImage_delete?id=${pd.id}&pid=${pd.pid}"><span
                                    class=" 	glyphicon glyphicon-trash"></span></a></td>
