        ...
        <table class="table table-striped table-bordered table-hover  table-condensed">
            ...
            <c:forEach items="${ps}" var="p">
                <tr>
                    ...
                    <td><a href="admin_product_editPropertyValue?pid=${p.id}&cid=${c.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                    <td><a href="admin_product_edit?id=${p.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                    <td><a deleteLink="true" href="admin_product_delete?pid=${p.id}&cid=${p.cid}"><span class="glyphicon glyphicon-trash"></span></a></td>
    ...
    <div class="panel-body">
        <form method="post" id="addForm" action="admin_product_add" enctype="multipart/form-data">
            <table class="addTable">
                ...
                <tr>
                    <td>原价格</td>
                    <td><input  id="oriPrice" name="originalPrice" type="text" placeholder="99.88" class="form-control"></td>
                </tr>
                <tr>
                    <td>优惠价格</td>
                    <td><input  id="proPrice" name="promotePrice" type="text" placeholder="19.88" class="form-control"></td>
                </tr>
                <tr>
                    <td>库存</td>
                    <td><input  id="stock" name="stock" type="text" placeholder="99" class="form-control"></td>
                </tr>
